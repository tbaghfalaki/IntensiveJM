...
for(kkk in c(1:NN)[-c(8,11,23,27,42,44,73,100)]){ 
...
apply(Results1[[kkk]]$Esti[-c(8,11,23,27,42,44,73,100),],2,mean)
apply(Results1[[kkk]]$CovR[-c(8,11,23,27,42,44,73,100),],2,mean)
AA=cbind(apply(Cr1[-c(8,11,23,27,42,44,73,100),],2,mean),apply(Cr1[-c(8,11,23,27,42,44,73,100),],2,sd))
mean(Time1[-c(8,11,23,27,42,44,73,100)]);sd(Time1[-c(8,11,23,27,42,44,73,100)]);
xtable::xtable(AA,digits=3)

MSE <- matrix(0, NN, length(Real))
for (i in 1:NN[-c(8,11,23,27,42,44,73,100)]) {
...
Res <- cbind(
  Real,
  apply(Results1[[kkk]]$Esti[-c(8,11,23,27,42,44,73,100),],2,mean),
  apply(Results1[[kkk]]$Esti[-c(8,11,23,27,42,44,73,100),],2,sd),
  (apply(Results1[[kkk]]$Esti[-c(8,11,23,27,42,44,73,100),],2,mean) - Real) / Real, # Relative bias
  sqrt(apply(MSE[-c(8,11,23,27,42,44,73,100),], 2, mean)),     # RMSE
  apply(Results1[[kkk]]$CovR[-c(8,11,23,27,42,44,73,100),],2,mean)
)
...
1 & -0.500 & -0.498 & 0.055 & -0.003 & 0.055 & 0.924 \\ 
2 & 0.200 & 0.202 & 0.072 & 0.011 & 0.072 & 0.957 \\ 
3 & -0.200 & -0.245 & 0.144 & 0.225 & 0.150 & 0.957 \\ 
\hline
\end{tabular}
\end{table}
> xtable::xtable(AA,digits=3)
% latex table generated in R 4.5.1 by xtable 1.8-4 package
% Tue Sep 30 16:01:54 2025
\begin{table}[ht]
\centering
\begin{tabular}{rrr}
\hline
...
> 
  ...
  ean(Time1[-c(8,11,23,27,42,44,73,100)]);sd(Time1[-c(8,11,23,27,42,44,73,100)]);
[1] 4.046674
[1] 0.1527899
> 
